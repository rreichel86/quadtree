...
c      ntyp = 592  4 edge SBFEM polygonal element rXc2
c
c      Inputs:
        ...
        do 400 j = 1,ns-1,inc
          ...
          if(me.gt.numel) go to 401
            ...
            if(me.gt.numel) go to 401
              ...
              ix(3,me) = 2*(nr+nodinc) + n+1
              n = n+1
            else if(ntyp.eq.592) then
              ix(1,me) = n-1
              ix(2,me) = n
              ix(3,me) = n+1
              
              ix(8,me) = nr+nodinc + n-1
              ix(4,me) = nr+nodinc + n+1
              
              ix(7,me) = 2*(nr+nodinc) + n-1
              ix(6,me) = 2*(nr+nodinc) + n
              ix(5,me) = 2*(nr+nodinc) + n+1
              n = n+1
