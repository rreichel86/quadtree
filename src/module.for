...
c.... 
c-----------------------------------------------------------------------
      integer :: nscoor,nselem,maxnel,pgrad, nkoin, snumn, extern
      end module
...
c     update ww KIT 11/14
c     update sk lbb 07/15
c-----------------------------------------------------------------------
      real*8 u_om(6),e_om(6),e_bar(6),eval
      end module 
...
c.... Purpose: isogeo.h
c-----------------------------------------------------------------------
!	  integer         Ininc,Inien,Inipa,Instre,Inkv1,Inoix            ok
!	  integer	      Inkv2,Inmpq,NURnpatch,NURlenkv(2),Inpro         ok
!	  integer		  ImdirP,IldirP,Iexactnormal,InumAreaGP           ok
!	  integer		  Inbasissys                                      ok
!	  integer		  InRupdinit                                      ok
!	  logical         nurbs                                           ok
!	  real*8          surface                                         ok
!       common /isogeo/ surface
!	  common /isogeo/ Ininc,Inien,Inipa,Instre,Inkv1,Inoix
!	  common /isogeo/ Inkv2,Inmpq,NURnpatch,NURlenkv,Inpro
!	  common /isogeo/ nurbs,ImdirP,IldirP,Iexactnormal
!	  common /isogeo/ InumAreaGP,InRupdinit
!	  common /isogeo/ Inbasissys
!
      integer  NURnpatch,NURlenkv(2),IldirP,Iexactnormal
      integer  InumAreaGP
      logical  nurbs
      real*8   surface
      integer, allocatable, dimension(:) :: AInmpq, AIninc, AInien,
     +         AInipa,AInoix
      real*8, allocatable, dimension(:) :: AInpro, AInstre
      real*8, allocatable, dimension(:) :: AInkv1, AInkv2
      real*8, allocatable, dimension(:) :: AImdirP
      integer, allocatable, dimension(:) :: AInRupdinit
	real*8, allocatable, dimension(:) :: AInbasissys
